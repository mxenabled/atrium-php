...
use AtriumMX\models\Connect;
use AtriumMX\models\Credential;
use AtriumMX\models\Institution;
use AtriumMX\models\Member;
use AtriumMX\models\Transaction;
use AtriumMX\models\User;
...
class AtriumClient
{
    ...
    {
        $response = $this->makeRequest(
            'GET', '/institutions/' . $institutionCode, ''
        );
    ...
    {
        $response = $this->makeRequest(
            'GET', '/institutions/' . $institutionCode . '/credentials', ''
        );
    ...
    function createMember($userGUID, $params)
    {
        ...
        $response = $this->makeRequest(
            'POST', '/users/' . $userGUID . '/members', $json
        );
    ...
    {
        $response = $this->makeRequest(
            'GET', '/users/' . $userGUID . '/members/' . $memberGUID, ''
        );
        return new Member(json_decode($response, true)['member']);
    }
    ...
    function updateMember($userGUID, $memberGUID, $params)
    {
        ...
        $response = $this->makeRequest(
            'PUT', '/users/' . $userGUID . '/members/' . $memberGUID, $json
        );
    ...
    function deleteMember($userGUID, $memberGUID)
    {
        return $this->makeRequest(
            'DELETE', '/users/' . $userGUID . '/members/' . $memberGUID, ''
        );
    }
    ...
    function listMemberMFAChallenges($userGUID, $memberGUID)
    {
        $response = $this->makeRequest(
            'GET',
            '/users/' . $userGUID . '/members/' . $memberGUID . '/challenges',
            ''
        );
    ...
    function resumeMemberAggregation($userGUID, $memberGUID, $challenges)
    {
        ...
        $response = $this->makeRequest(
            'PUT',
            '/users/' . $userGUID . '/members/' . $memberGUID . '/resume', $json
        );
    ...
    function listMemberCredentials($userGUID, $memberGUID)
    {
        $response = $this->makeRequest(
            'GET',
            '/users/' . $userGUID . '/members/' . $memberGUID . '/credentials',
            ''
        );
        $credentials = json_decode($response, true)['credentials'];
    ...
    {
        $response = $this->makeRequest(
            'GET', '/users/' . $userGUID . '/accounts/' . $accountGUID, ''
        );
    ...
    {
        $response = $this->makeRequest(
            'GET', '/users/' . $userGUID . '/transactions/' . $transactionGUID,
            ''
        );
    ...
    {
        $response = $this->makeRequest(
            'GET', '/users/' . $userGUID . '/transactions', ''
        );
        $transactions = json_decode($response, true)['transactions'];
    ...
    {
        $response = $this->makeRequest(
            'POST', '/users/' . $userGUID . '/connect_widget_url', ''
        );
