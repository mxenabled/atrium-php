...
class IdentityApi
{
     ...
     * @throws \atrium-php\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \atrium-php\atrium-php\AccountOwners
     */
     ...
     * @throws \atrium-php\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \atrium-php\atrium-php\AccountOwners, HTTP status code, HTTP response headers (array of strings)
     */
    public function listAccountOwnersWithHttpInfo($member_guid, $user_guid)
    {
        $returnType = '\atrium-php\atrium-php\AccountOwners';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\atrium-php\atrium-php\AccountOwners',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
