...
/**
 * TransactionAttributes Class Doc Comment
 *
 * @category Class
 * @package  atrium-php
 */
class TransactionAttributes implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $mxModelName = 'TransactionAttributes';
