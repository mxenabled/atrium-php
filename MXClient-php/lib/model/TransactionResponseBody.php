...
/**
 * TransactionResponseBody Class Doc Comment
 *
 * @category Class
 * @package  atrium
 */
class TransactionResponseBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $mxModelName = 'TransactionResponseBody';
    ...
    protected static $mxTypes = [
        'transaction' => '\atrium\model\Transaction'
    ];
     ...
     * Sets transaction
     *
     * @param \atrium\model\Transaction $transaction transaction
     *
     * @return $this
     */
