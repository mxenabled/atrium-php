...
/**
 * CredentialResponseAttributes Class Doc Comment
 *
 * @category Class
 * @package  atrium
 */
class CredentialResponseAttributes implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $mxModelName = 'CredentialResponseAttributes';
