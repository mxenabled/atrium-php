...
/**
 * AccountNumbers Class Doc Comment
 *
 * @category Class
 * @package  atrium
 */
class AccountNumbers implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $mxModelName = 'AccountNumbers';
    ...
    protected static $mxTypes = [
        'account_numbers' => '\atrium\model\AccountNumberAttributes[]'
    ];
     ...
     *
     * @return \atrium\model\AccountNumberAttributes[]
     */
     ...
     *
     * @param \atrium\model\AccountNumberAttributes[] $account_numbers account_numbers
     *
     * @return $this
     */
