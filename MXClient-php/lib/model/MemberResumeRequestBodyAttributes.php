...
/**
 * MemberResumeRequestBodyAttributes Class Doc Comment
 *
 * @category Class
 * @package  atrium
 */
class MemberResumeRequestBodyAttributes implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $mxModelName = 'MemberResumeRequestBodyAttributes';
    ...
    protected static $mxTypes = [
        'challenges' => '\atrium\model\CredentialResponseAttributes[]'
    ];
     ...
     * Sets challenges
     *
     * @param \atrium\model\CredentialResponseAttributes[] $challenges challenges
     *
     * @return $this
     */
