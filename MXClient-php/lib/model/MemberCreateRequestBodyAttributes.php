...
/**
 * MemberCreateRequestBodyAttributes Class Doc Comment
 *
 * @category Class
 * @package  atrium
 */
class MemberCreateRequestBodyAttributes implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $mxModelName = 'MemberCreateRequestBodyAttributes';
