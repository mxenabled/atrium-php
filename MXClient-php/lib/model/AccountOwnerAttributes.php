...
/**
 * AccountOwnerAttributes Class Doc Comment
 *
 * @category Class
 * @package  atrium
 */
class AccountOwnerAttributes implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $mxModelName = 'AccountOwnerAttributes';
