 ...
 * @package  atrium
 */
class AccountResponseBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $mxModelName = 'AccountResponseBody';
     ...
     * Sets account
     *
     * @param \atrium\model\Account $account account
     *
     * @return $this
     */
