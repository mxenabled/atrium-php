...
/**
 * InstitutionAttributes Class Doc Comment
 *
 * @category Class
 * @package  atrium
 */
class InstitutionAttributes implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $mxModelName = 'InstitutionAttributes';
