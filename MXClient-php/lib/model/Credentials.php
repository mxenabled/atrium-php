...
class Credentials implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $mxModelName = 'Credentials';
    ...
    protected static $mxTypes = [
        'credentials' => '\atrium\model\CredentialAttributes[]'
    ];
     ...
     * Gets credentials
     *
     * @return \atrium\model\CredentialAttributes[]
     */
     ...
     * Sets credentials
     *
     * @param \atrium\model\CredentialAttributes[] $credentials credentials
     *
     * @return $this
     */
