...
/**
 * MemberConnectionStatusAttributes Class Doc Comment
 *
 * @category Class
 * @package  atrium
 */
class MemberConnectionStatusAttributes implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $mxModelName = 'MemberConnectionStatusAttributes';
    ...
    protected static $mxTypes = [
        ...
        'challenges' => '\atrium\model\ChallengeAttributes[]',
     ...
     * Gets challenges
     *
     * @return \atrium\model\ChallengeAttributes[]
     */
     ...
     * Sets challenges
     *
     * @param \atrium\model\ChallengeAttributes[] $challenges challenges
     *
     * @return $this
     */
