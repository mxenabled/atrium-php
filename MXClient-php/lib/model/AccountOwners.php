...
/**
 * AccountOwners Class Doc Comment
 *
 * @category Class
 * @package  atrium
 */
class AccountOwners implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $mxModelName = 'AccountOwners';
    ...
    protected static $mxTypes = [
        'account_owners' => '\atrium\model\AccountOwnerAttributes[]'
    ];
     ...
     * Gets account_owners
     *
     * @return \atrium\model\AccountOwnerAttributes[]
     */
     ...
     * Sets account_owners
     *
     * @param \atrium\model\AccountOwnerAttributes[] $account_owners account_owners
     *
     * @return $this
     */
