...
/**
 * ChallengeAttributes Class Doc Comment
 *
 * @category Class
 * @package  atrium
 */
class ChallengeAttributes implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $mxModelName = 'ChallengeAttributes';
     ...
     * Gets options
     *
     * @return \atrium\model\ChallengeOptionAttributes[]
     */
     ...
     * Sets options
     *
     * @param \atrium\model\ChallengeOptionAttributes[] $options options
     *
     * @return $this
     */
