...
/**
 * UsersResponseBody Class Doc Comment
 *
 * @category Class
 * @package  atrium
 */
class UsersResponseBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $mxModelName = 'UsersResponseBody';
     ...
     * Sets users
     *
     * @param \atrium\model\User[] $users users
     *
     * @return $this
     */
