...
class Accounts implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $mxModelName = 'Accounts';
    ...
    protected static $mxTypes = [
        'accounts' => '\atrium\model\AccountAttributes[]',
     ...
     * Gets accounts
     *
     * @return \atrium\model\AccountAttributes[]
     */
     ...
     * Sets accounts
     *
     * @param \atrium\model\AccountAttributes[] $accounts accounts
     *
     * @return $this
     */
