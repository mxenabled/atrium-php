...
/**
 * MemberConnectionStatusResponseBody Class Doc Comment
 *
 * @category Class
 * @package  atrium
 */
class MemberConnectionStatusResponseBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $mxModelName = 'MemberConnectionStatusResponseBody';
    ...
    protected static $mxTypes = [
        'member' => '\atrium\model\MemberConnectionStatus'
    ];
     ...
     * Sets member
     *
     * @param \atrium\model\MemberConnectionStatus $member member
     *
     * @return $this
     */
