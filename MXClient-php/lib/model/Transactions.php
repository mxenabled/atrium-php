...
class Transactions implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $mxModelName = 'Transactions';
    ...
    protected static $mxTypes = [
        'transactions' => '\atrium\model\TransactionAttributes[]',
     ...
     * Gets transactions
     *
     * @return \atrium\model\TransactionAttributes[]
     */
     ...
     * Sets transactions
     *
     * @param \atrium\model\TransactionAttributes[] $transactions transactions
     *
     * @return $this
     */
