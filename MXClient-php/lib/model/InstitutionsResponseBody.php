...
/**
 * InstitutionsResponseBody Class Doc Comment
 *
 * @category Class
 * @package  atrium
 */
class InstitutionsResponseBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $mxModelName = 'InstitutionsResponseBody';
    ...
    protected static $mxTypes = [
        'institutions' => '\atrium\model\Institution[]',
     ...
     * Sets institutions
     *
     * @param \atrium\model\Institution[] $institutions institutions
     *
     * @return $this
     */
