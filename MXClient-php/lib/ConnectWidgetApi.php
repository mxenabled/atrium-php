...
class ConnectWidgetApi
{
     ...
     * @param  \atrium-php\atrium-php\ConnectWidgetRequestBody $body Optional config options for WebView (is_mobile_webview, current_institution_code, current_member_guid, update_credentials) (required)
     *
     * @throws \atrium-php\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \atrium-php\atrium-php\ConnectWidget
     */
     ...
     * @throws \atrium-php\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \atrium-php\atrium-php\ConnectWidget, HTTP status code, HTTP response headers (array of strings)
     */
    public function getConnectWidgetWithHttpInfo($user_guid, $body)
    {
        $returnType = '\atrium-php\atrium-php\ConnectWidget';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\atrium-php\atrium-php\ConnectWidget',
