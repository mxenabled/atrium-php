...
/**
 * UserCreateRequestBody Class Doc Comment
 *
 * @category Class
 * @package  atrium-php
 */
class UserCreateRequestBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $mxModelName = 'UserCreateRequestBody';
