...
class UsersApi
{
     ...
     * Create user
     *
     * @param  \atrium-php\atrium-php\UserCreateRequestBody $body User object to be created with optional parameters (identifier, is_disabled, metadata) (required)
     *
     * @throws \atrium-php\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \atrium-php\atrium-php\User
     */
     ...
     * @throws \atrium-php\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \atrium-php\atrium-php\User, HTTP status code, HTTP response headers (array of strings)
     */
    public function createUserWithHttpInfo($body)
    {
        $returnType = '\atrium-php\atrium-php\User';
     ...
     * @throws \atrium-php\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \atrium-php\atrium-php\Users
     */
     ...
     * @throws \atrium-php\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \atrium-php\atrium-php\Users, HTTP status code, HTTP response headers (array of strings)
     */
    public function listUsersWithHttpInfo($page = null, $records_per_page = null)
    {
        $returnType = '\atrium-php\atrium-php\Users';
     ...
     *
     * @param  string $user_guid The unique identifier for a &#x60;user&#x60;. (required)
     * @param  \atrium-php\atrium-php\UserUpdateRequestBody $body User object to be updated with optional parameters (identifier, is_disabled, metadata) (optional)
     *
     * @throws \atrium-php\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \atrium-php\atrium-php\User
