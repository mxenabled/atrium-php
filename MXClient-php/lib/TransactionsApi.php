...
class TransactionsApi
{
     ...
     *
     * @param  \atrium-php\atrium-php\TransactionsCleanseAndCategorizeRequestBody $body User object to be created with optional parameters (amount, type) amd required parameters (description, identifier) (required)
     *
     * @throws \atrium-php\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \atrium-php\atrium-php\TransactionsCleanseAndCategorize
     */
     ...
     * @throws \atrium-php\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \atrium-php\atrium-php\TransactionsCleanseAndCategorize, HTTP status code, HTTP response headers (array of strings)
     */
    public function cleanseAndCategorizeTransactionsWithHttpInfo($body)
    {
        $returnType = '\atrium-php\atrium-php\TransactionsCleanseAndCategorize';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\atrium-php\atrium-php\TransactionsCleanseAndCategorize',
     ...
     * @throws \atrium-php\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \atrium-php\atrium-php\Transaction
     */
     ...
     * @throws \atrium-php\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \atrium-php\atrium-php\Transaction, HTTP status code, HTTP response headers (array of strings)
     */
    public function readTransactionWithHttpInfo($transaction_guid, $user_guid)
    {
        $returnType = '\atrium-php\atrium-php\Transaction';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\atrium-php\atrium-php\Transaction',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
