...
class VerificationApi
{
     ...
     * @return \atrium-php\atrium-php\AccountNumbers
     */
     ...
     * @throws \atrium-php\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \atrium-php\atrium-php\AccountNumbers, HTTP status code, HTTP response headers (array of strings)
     */
    public function listAccountNumbersWithHttpInfo($member_guid, $user_guid)
    {
        $returnType = '\atrium-php\atrium-php\AccountNumbers';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\atrium-php\atrium-php\AccountNumbers',
