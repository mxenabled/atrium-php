...
/**
 * TransactionsCleanseAndCategorizeRequestBodyAttributes Class Doc Comment
 *
 * @category Class
 * @package  atrium-php
 */
class TransactionsCleanseAndCategorizeRequestBodyAttributes implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $mxModelName = 'TransactionsCleanseAndCategorizeRequestBodyAttributes';
