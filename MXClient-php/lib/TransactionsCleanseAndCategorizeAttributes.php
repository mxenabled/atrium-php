...
/**
 * TransactionsCleanseAndCategorizeAttributes Class Doc Comment
 *
 * @category Class
 * @package  atrium-php
 */
class TransactionsCleanseAndCategorizeAttributes implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $mxModelName = 'TransactionsCleanseAndCategorizeAttributes';
