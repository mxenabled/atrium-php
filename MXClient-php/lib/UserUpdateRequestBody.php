...
/**
 * UserUpdateRequestBody Class Doc Comment
 *
 * @category Class
 * @package  atrium-php
 */
class UserUpdateRequestBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $mxModelName = 'UserUpdateRequestBody';
    ...
    protected static $mxTypes = [
        'user' => '\atrium-php\atrium-php\UserAttributes'
    ];
     ...
     * Sets user
     *
     * @param \atrium-php\atrium-php\UserAttributes $user user
     *
     * @return $this
     */
