...
class AccountsApi
{
     ...
     * @throws \atrium-php\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \atrium-php\atrium-php\Account
     */
     ...
     * @throws \atrium-php\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \atrium-php\atrium-php\Account, HTTP status code, HTTP response headers (array of strings)
     */
    public function readAccountWithHttpInfo($account_guid, $user_guid)
    {
        $returnType = '\atrium-php\atrium-php\Account';
