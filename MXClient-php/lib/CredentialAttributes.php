...
/**
 * CredentialAttributes Class Doc Comment
 *
 * @category Class
 * @package  atrium-php
 */
class CredentialAttributes implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $mxModelName = 'CredentialAttributes';
