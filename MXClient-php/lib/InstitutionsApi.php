...
class InstitutionsApi
{
     ...
     * @return \atrium-php\atrium-php\Institutions
     */
     ...
     * @throws \atrium-php\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \atrium-php\atrium-php\Institutions, HTTP status code, HTTP response headers (array of strings)
     */
    public function listInstitutionsWithHttpInfo($name = null, $page = null, $records_per_page = null)
    {
        $returnType = '\atrium-php\atrium-php\Institutions';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\atrium-php\atrium-php\Institutions',
     ...
     * @throws \atrium-php\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \atrium-php\atrium-php\Institution
     */
     ...
     * @throws \atrium-php\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \atrium-php\atrium-php\Institution, HTTP status code, HTTP response headers (array of strings)
     */
    public function readInstitutionWithHttpInfo($institution_code)
    {
        $returnType = '\atrium-php\atrium-php\Institution';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\atrium-php\atrium-php\Institution',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
