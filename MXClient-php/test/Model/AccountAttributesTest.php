...
/**
 * AccountAttributesTest Class Doc Comment
 *
 * @category    Class
 * @description AccountAttributes
 * @package     atrium-php
 */
class AccountAttributesTest extends \PHPUnit_Framework_TestCase
{
