...
/**
 * TransactionsResponseBody Class Doc Comment
 *
 * @category Class
 * @package  atrium
 */
class TransactionsResponseBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $mxModelName = 'TransactionsResponseBody';
    ...
    protected static $mxTypes = [
        'transactions' => '\atrium\model\Transaction[]',
     ...
     * Sets transactions
     *
     * @param \atrium\model\Transaction[] $transactions transactions
     *
     * @return $this
     */
