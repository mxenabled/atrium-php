...
/**
 * AccountNumbersResponseBody Class Doc Comment
 *
 * @category Class
 * @package  atrium
 */
class AccountNumbersResponseBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $mxModelName = 'AccountNumbersResponseBody';
    ...
    protected static $mxTypes = [
        'account_numbers' => '\atrium\model\AccountNumber[]'
    ];
    ...
    {
        $this->container['account_numbers'] = isset($data['account_numbers']) ? $data['account_numbers'] : null;
    }
     ...
     *
     * @return \atrium\model\AccountNumber[]
     */
     ...
     *
     * @param \atrium\model\AccountNumber[] $account_numbers account_numbers
     *
     * @return $this
     */
