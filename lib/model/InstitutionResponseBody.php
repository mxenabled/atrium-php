...
/**
 * InstitutionResponseBody Class Doc Comment
 *
 * @category Class
 * @package  atrium
 */
class InstitutionResponseBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $mxModelName = 'InstitutionResponseBody';
    ...
    protected static $mxTypes = [
        'institution' => '\atrium\model\Institution'
    ];
     ...
     * Sets institution
     *
     * @param \atrium\model\Institution $institution institution
     *
     * @return $this
     */
