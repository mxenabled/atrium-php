...
/**
 * MemberResumeRequest Class Doc Comment
 *
 * @category Class
 * @package  atrium
 */
class MemberResumeRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $mxModelName = 'MemberResumeRequest';
    ...
    protected static $mxTypes = [
        'challenges' => '\atrium\model\CredentialRequest[]'
    ];
     ...
     * Sets challenges
     *
     * @param \atrium\model\CredentialRequest[] $challenges challenges
     *
     * @return $this
     */
