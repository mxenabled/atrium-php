...
/**
 * ConnectWidgetResponseBody Class Doc Comment
 *
 * @category Class
 * @package  atrium
 */
class ConnectWidgetResponseBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $mxModelName = 'ConnectWidgetResponseBody';
    ...
    protected static $mxTypes = [
        'user' => '\atrium\model\ConnectWidget'
    ];
     ...
     * Sets user
     *
     * @param \atrium\model\ConnectWidget $user user
     *
     * @return $this
     */
