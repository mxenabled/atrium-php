...
/**
 * MemberResponseBody Class Doc Comment
 *
 * @category Class
 * @package  atrium
 */
class MemberResponseBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $mxModelName = 'MemberResponseBody';
     ...
     * Sets member
     *
     * @param \atrium\model\Member $member member
     *
     * @return $this
     */
