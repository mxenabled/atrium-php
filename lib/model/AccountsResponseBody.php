...
/**
 * AccountsResponseBody Class Doc Comment
 *
 * @category Class
 * @package  atrium
 */
class AccountsResponseBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $mxModelName = 'AccountsResponseBody';
     ...
     * Sets accounts
     *
     * @param \atrium\model\Account[] $accounts accounts
     *
     * @return $this
     */
