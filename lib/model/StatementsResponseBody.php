...
/**
 * StatementsResponseBody Class Doc Comment
 *
 * @category Class
 * @package  atrium
 */
class StatementsResponseBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $mxModelName = 'StatementsResponseBody';
    ...
    protected static $mxTypes = [
        'statements' => '\atrium\model\Statement[]',
     ...
     * Sets statements
     *
     * @param \atrium\model\Statement[] $statements statements
     *
     * @return $this
     */
