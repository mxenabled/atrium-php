 ...
 * @package  atrium
 */
class CredentialResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $mxModelName = 'CredentialResponse';
    ...
    protected static $mxTypes = [
        ...
        'guid' => 'string',
        'label' => 'string',
        'options' => '\atrium\model\CredentialOption[]',
        'type' => 'string'
    ];
     ...
     * Gets options
     *
     * @return \atrium\model\CredentialOption[]
     */
     ...
     * Sets options
     *
     * @param \atrium\model\CredentialOption[] $options options
     *
     * @return $this
     */
