...
class MembersApi
{
     ...
     * @param  string $type An optional parameter which determines the type of aggregation to be peformed. Possible values are &#x60;statement&#x60; and &#x60;history&#x60;. (optional)
     *
     * @throws \atrium\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \atrium\model\MemberResponseBody
     */
    public function aggregateMember($member_guid, $user_guid, $type = null)
    {
        list($response) = $this->aggregateMemberWithHttpInfo($member_guid, $user_guid, $type);
        return $response;
    }
     ...
     */
    public function aggregateMemberWithHttpInfo($member_guid, $user_guid, $type = null)
    {
        $returnType = '\atrium\model\MemberResponseBody';
        $request = $this->aggregateMemberRequest($member_guid, $user_guid, $type);
     ...
     */
    public function aggregateMemberAsync($member_guid, $user_guid, $type = null)
    {
        return $this->aggregateMemberAsyncWithHttpInfo($member_guid, $user_guid, $type)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function aggregateMemberAsyncWithHttpInfo($member_guid, $user_guid, $type = null)
    {
        $returnType = '\atrium\model\MemberResponseBody';
        $request = $this->aggregateMemberRequest($member_guid, $user_guid, $type);
     ...
     */
    protected function aggregateMemberRequest($member_guid, $user_guid, $type = null)
    {
